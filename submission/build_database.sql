...
CREATE TABLE DimBreed (
	BreedID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimBreedLabels (
	BreedLabelID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimColor (
	ColorID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimColorLabels (
	ColorLabelID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimLocation (
	LocationID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
	State INT
);
GO
...
CREATE TABLE DimGender (
	GenderID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimType (
	TypeID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimAge (
	AgeID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
	Age INT NOT NULL
);
GO
...
CREATE TABLE DimMaturitySize (
	MaturitySizeID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimFurLength (
	FurLengthID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimVaccinated (
	VaccinatedID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimDewormed (
	DewormedID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
	Dewormed VARCHAR(8)
);
GO
...
CREATE TABLE DimSterilized (
	SterilizedID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
...
CREATE TABLE DimHealth (
	HealthID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
	Health VARCHAR(14)
);
GO
...
CREATE TABLE DimRescuer (
	RescuerID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
	Rescuer VARCHAR(32)
);
GO
...
CREATE TABLE FactPetAdoptionSpeed (
	PetID INT PRIMARY KEY IDENTITY AUTO_INCREMENT,
	PetAltID VARCHAR(9),
	BreedID INT,
	ColorID INT,
	TypeID INT,
